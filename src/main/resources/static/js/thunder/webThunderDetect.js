...
function thunderRandomChar(len) {
    ...
    var rand_str = "";
    for (var i = 0; i < len; i++) { rand_str += x.charAt(Math.ceil(Math.random() * 100000000) % x.length); }
    return rand_str; }
...
(function() {
    ...
    (function(A, w) {
        function ma() {
            if (!c.isReady) {
                try { s.documentElement.doScroll("left") } catch (a) { setTimeout(ma, 1);
                    return }
                c.ready() } }
        ...
        c.fn = c.prototype = {
            init: function(a, b) {
                ...
                if (typeof a === "string")
                    if ((d = Ta.exec(a)) &&
                        (d[1] || !b))
                        if (d[1]) { f = b ? b.ownerDocument || b : s;
                            if (a = Xa.exec(a))
        ...
        c.extend({
                ...
                if (d)
                    if (i)
                        for (f in a) {
                            ...
                            for (; e < j;) {
                                if (b.apply(a[e++], d) === false) break } else if (i)
                                for (f in a) {
            ...
            grep: function(a, b, d) {
                ...
                return f },
            map: function(a, b, d) {
                for (var f = [], e, j = 0, i = a.length; j < i; j++) { e = b(a[j], j, d);
        ...
        if (s.addEventListener) L = function() { s.removeEventListener("DOMContentLoaded", L, false);
            ...
            if (s.readyState === "complete") { s.detachEvent("onreadystatechange", L);
                c.ready() } };
        (function() {
            c.support = {};
        ...
        c.extend({
            ...
            data: function(a, b, d) {
                if (!(a.nodeName && c.noData[a.nodeName.toLowerCase()])) { a = a == A ? za : a;
                    var f = a[G],
                        e = c.cache;
        ...
        c.fn.extend({
            data: function(a, b) {
                ...
                if (b === w) {
                    ...
                    return f === w && d[1] ? this.data(d[0]) : f } else return this.trigger("setData" + d[1] + "!", [d[0], b]).each(function() {
                    c.data(this,
                        a, b)
                })
            },
        ...
        c.extend({ queue: function(a, b, d) {
                if (a) { b = (b || "fx") + "queue";
                    ...
                    return f } }, dequeue: function(a, b) { b = b || "fx";
                var d = c.queue(a, b),
                    f = d.shift();
                ...
                if (!(a.nodeType === 3 || a.nodeType === 8)) {
                    ...
                    if (z && C) {
                        ...
                        if (!b || typeof b === "string" && b.charAt(0) === ".") { b = b || "";
                            for (e in C) c.event.remove(a, e + b) } else {
                            for (b = b.split(" "); e = b[j++];) {
                                n = e;
                                i = e.indexOf(".") < 0;
                                o = [];
                                ...
                                if (r = C[e])
                                    if (d) {
                                        ...
                                        for (var B = 0; B < r.length; B++) { u = r[B];
        ...
        c.Event.prototype = {
            preventDefault: function() { this.isDefaultPrevented = Z;
        ...
        if (!c.support.submitBubbles) c.event.special.submit = { setup: function() {
                if (this.nodeName.toLowerCase() !== "form") { c.event.add(this, "click.specialSubmit", function(a) {
                    ...
                    c.event.add(this, "keypress.specialSubmit", function(a) {
                        var b = a.target,
                            d = b.type;
                        if ((d === "text" || d === "password") && c(b).closest("form").length && a.keyCode === 13) return na("submit", this, arguments) }) } else return false }, teardown: function() { c.event.remove(this, ".specialSubmit") } };
        ...
        c.each(["bind", "one"], function(a, b) { c.fn[b] = function(d, f, e) {
                if (typeof d === "object") {
        ...
        c.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error".split(" "),
            function(a, b) { c.fn[b] = function(d) {
        ...
        (function() {
                    ...
                    if (t) { t = t[g];
                        for (var y = false; t;) {
                            ...
                            if (t.nodeType === 1) {
                                ...
                                if (typeof h !== "string") {
                                    if (t === h) { y = true;
                                        break } } else if (k.filter(h, [t]).length > 0) { y = t;
                                    break } }
                            t = t[g] }
                        m[q] = y } } }
            var f = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^[\]]*\]|['"][^'"]*['"]|[^[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,
                ...
                if (p.length > 1 && r.exec(g))
                    if (p.length === 2 && n.relative[p[0]]) t = ga(p[0] + p[1], h);
                        ...
                        for (t = n.relative[p[0]] ? [h] : k(p.shift(), h); p.length;) {
                            ...
                            if (!m && p.length > 1 && h.nodeType === 9 && !M && n.match.ID.test(p[0]) && !n.match.ID.test(p[p.length - 1])) { v = k.find(p.shift(), h, M);
                            ...
                            if (D.substr(D.length -
                                ...
                                if (n.preFilter[H])
                                    if (t = n.preFilter[H](t, v, l, p, m, S)) {
                                        if (t === true) continue } else y = I = true;
                                if (t)
                                    for (var U = 0;
                                        (D = v[U]) != null; U++)
                                        if (D) { I = M(D, t, U, v);
            ...
            var n = k.selectors = {
                    ...
                    setFilters: { first: function(g, h) {
                            return h === 0 }, last: function(g, h, l, m) {
                            return h === m.length - 1 }, even: function(g, h) {
                            return h % 2 === 0 }, odd: function(g, h) {
                            return h % 2 === 1 }, lt: function(g, h, l) {
                            return h < l[3] - 0 }, gt: function(g, h, l) {
                            return h > l[3] - 0 }, nth: function(g, h, l) {
                            return l[3] - 0 === h }, eq: function(g, h, l) {
                            return l[3] - 0 === h } },
                    filter: {
            ...
            var z = function(g, h) { g = Array.prototype.slice.call(g, 0);
                if (h) { h.push.apply(h, g);
                    return h }
                return g };
            try { Array.prototype.slice.call(s.documentElement.childNodes, 0) } catch (C) { z = function(g, h) { h = h || [];
            ...
            s.querySelectorAll && function() {
                ...
                if (!(h.querySelectorAll && h.querySelectorAll(".TEST").length === 0)) { k = function(m, q, p, v) { q = q || s;
                        if (!v && q.nodeType === 9 && !x(q)) try {
                            return z(q.querySelectorAll(m), p) } catch (t) {}
                        return g(m, q, p, v) };
            ...
            var E = s.compareDocumentPosition ? function(g, h) {
                ...
                ga = function(g, h) {
                    var l = [],
                        m = "",
                        q;
                    for (h = h.nodeType ? [h] : h; q = n.match.PSEUDO.exec(g);) { m += q[0];
            ...
            closest: function(a, b) {
                if (c.isArray(a)) {
                    var d = [],
                        ...
                        i;
                    if (f && a.length) { e = 0;
                        for (var o = a.length; e < o; e++) { i = a[e];
        ...
        }, function(a, b) { c.fn[a] = function(d, f) {
            ...
            remove: function(a, b) {
                for (var d = 0, f;
                    ...
                    if (!a || c.filter(a, [f]).length) {
                        if (!b && f.nodeType === 1) { c.cleanData(f.getElementsByTagName("*"));
                            c.cleanData([f]) }
                ...
                var b = this.map(function() {
                    if (!c.support.noCloneEvent && !c.isXMLDoc(this)) {
                        ...
                        if (!d) { d = f.createElement("div");
                            ...
                            d = d.innerHTML }
                        return c.clean([d.replace(Ja, "").replace(/=([^="'>\s]+\/)>/g, '="$1">').replace(V, "")], f)[0] } else return this.cloneNode(true) });
                if (a === true) { ra(this, b);
                    ra(this.find("*"), b.find("*")) }
                return b },
            html: function(a) {
                    ...
                    try {
                        for (var b = 0, d = this.length; b < d; b++)
                            if (this[b].nodeType === 1) { c.cleanData(this[b].getElementsByTagName("*"));
                                this[b].innerHTML = a } } catch (f) { this.empty().append(a) } } else c.isFunction(a) ? this.each(function(e) {
                    var j = c(this),
                        i = j.html();
                    j.empty().append(function() {
                        return a.call(this, e, i) }) }) : this.empty().append(a);
                return this
            },
            ...
            domManip: function(a, b, d) {
                ...
                if (this[0]) {
                    ...
                    if (j = k.childNodes.length ===
                        1 ? (k = k.firstChild) : k.firstChild) { b = b && c.nodeName(j, "tr");
                    ...
                    if (i) {
                        if (typeof i === "string" && !jb.test(i)) i = b.createTextNode(i);
                            ...
                            if (!c.support.tbody) { n = ib.test(i);
                                ...
                                for (k = o.length - 1; k >= 0; --k) c.nodeName(o[k], "tbody") && !o[k].childNodes.length && o[k].parentNode.removeChild(o[k]) }!c.support.leadingWhitespace && V.test(i) && r.insertBefore(b.createTextNode(V.exec(i)[0]), r.firstChild);
                            i = r.childNodes
                        }
        ...
        c.fn.extend({
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    return this.name && !this.disabled && (this.checked || ub.test(this.nodeName) || vb.test(this.type)) }).map(function(a, b) { a = c(this).val();
                    return a == null ? null : c.isArray(a) ? c.map(a, function(d) {
                        return { name: b.name, value: d } }) : { name: b.name, value: a } }).get() }
        });
        ...
        c.extend({
            ...
            ajaxSettings: {
                ...
                xhr: A.XMLHttpRequest && (A.location.protocol !== "file:" || !A.ActiveXObject) ? function() {
                    return new A.XMLHttpRequest } : function() {
                    try {
                        return new A.ActiveXObject("Microsoft.XMLHTTP") } catch (a) {} },
                ...
                if (e.dataType === "script" && n === "GET" && r) {
                    ...
                    if (!j) {
                        ...
                        C.onload = C.onreadystatechange = function() {
                            if (!B && (!this.readyState || this.readyState === "loaded" || this.readyState === "complete")) { B = true;
                                b();
                                d();
                ...
                if (x) {
                    ...
                    var g = x.onreadystatechange = function(q) {
                        if (!x || x.readyState === 0 || q === "abort") {
                            ...
                            var p;
                            if (i === "success") try { o = c.httpData(x, e.dataType, e) } catch (v) { i = "parsererror";
                                p = v }
        ...
        c.each({ slideDown: K("show", 1), slideUp: K("hide", 1), slideToggle: K("toggle", 1), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" } }, function(a, b) { c.fn[a] = function(d, f) {
        ...
        c.extend({
            ...
            easing: { linear: function(a, b, d, f) {
                    return d + f * a }, swing: function(a, b, d, f) {
        ...
        c.fn.offset = "getBoundingClientRect" in s.documentElement ?
            function(a) {
                ...
                b = f.body;
                f = f.documentElement;
                return { top: d.top + (self.pageYOffset || c.support.boxModel && f.scrollTop || b.scrollTop) - (f.clientTop || b.clientTop || 0), left: d.left + (self.pageXOffset || c.support.boxModel && f.scrollLeft || b.scrollLeft) - (f.clientLeft || b.clientLeft || 0) } } : function(a) {
                var b =
                    this[0];
    ...
    function _xlThunderQtyPV() {
        try { vhref = "http://analytics-union.xunlei.com/PV?peerid=0&uri=http://thunderqtypv.union.xunlei.com&src=" + document.domain;
            image1 = new Image(1, 1);
            image1.src = vhref; } catch (e) {} }
    ...
    isObject = function(a) {
        return (a && typeof a == "object") || isFun(a); };
    isString = function(a) {
        ...
        } else if (browserName == 'MacBrowser') //mac handle
        {
            ...
            if (false) {
                ...
                if (selectType == 3 || selectType == 4) {
                    Thunder.thunderType = selectType;
                    // if(selectType==3) Thunder.mustUseSelected=true;
                }

                if (typeof(isOpenNewWindow) != "boolean") {
                    if (isNaN(isOpenNewWindow)) isOpenNewWindow = undefined;
                    else isOpenNewWindow = Number(isOpenNewWindow);
        ...
        getInstance: function(th) {
            ...
            if (this.judgeThunder()) {
                ...
                if (!this.thunderType) {
                    ...
                    } catch (e) { this.thunderType = 3;
                        this.mustUseSelected = false; }
                } else {
        ...
        if (!fFXbPlugin) {
            ...
            var XHR = jQuery.ajax({
                ...
                success: function(rtnData) {
                    ...
                    if (isUndef(rtnData.data.format)) {} else {
            ...
            function showHtml(rtnData) {
                ...
                jQuery('#union_tuijian_lx').unbind('click').click(function() {
                    try {
                        var url = "http://pv.xmp.stat.xunlei.com/UPV?gs=uniondown155&click=1";
                        var image = new Image();
                        image.src = url; } catch (e) {}
    ...
    function uniondown(style, movie) {
        try {
            var url = "http://pv.xmp.stat.xunlei.com/UPV?gs=uniondown&style=" + style + "&movie=" + encodeURIComponent(movie) + '&t=' + (new Date());
            var image = new Image();
            image.src = url; } catch (e) {}
        if (style == "pt") {
            hide();
